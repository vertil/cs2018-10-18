...
class TaskA1 {
    public static void main(String[] args) {
        ...
        int del = a / b;
        int dels = a % b;
        System.out.println(sum + " " + raz + " " + ymn + " " + del + " " + dels);


        double sum1 =  ((double)a) + b ;
        double raz1 =  ((double)a) -  b;
        double ymn1 =  (((double) a) * b);
        double del1 = ((double)a / b);
        double dels1 = ((double)a % b);
        System.out.println(sum1+" "+raz1+" "+ymn1+" "+del1+" "+dels1);
    }
